...
(assert |b8[cast:U_2_bool]|)
(assert |b9[funType:bool_2_U]|)
(assert |b20[DafnyPreludebpl.89:29]|)
(assert |b22[typeInv:IMapTypeInv0]|)
(assert |b25[funType:IMap#Domain]|)
(assert |b27[funType:PagedBetree.ChildMap.mapp]|)
(assert |b28[PagedBetreeidfy.49:15]|)
(assert (= (type $LZ) LayerTypeType))
(assert (or (not (<= 9 $FunctionContextHeight)) |b30[PagedBetreeidfy.49:15!1085]|))
(assert |b31[unknown.0:0!1121]|)
(assert |b32[PagedBetreeidfy.69:5!1156]|)
(assert (or (not (<= 9 $FunctionContextHeight)) |b33[PagedBetreeidfy.72:15!1188]|))
...
(assert (or (not true) |b34[Buffersidfy.15:20!1659]|))
(assert (or (not true) |b35[Buffersidfy.16:19!1676]|))
...
(assert (! (=> |b9[funType:bool_2_U]| (= (type (bool_2_U (TotalKMMapMod.__default.TerminalValue (Lit TotalKMMapMod.__default.DefaultV)))) boolType)) :named |0x7fe12995f8c8-funType:bool_2_U[arg0@@4=(TotalKMMapMod.__default.TerminalValue (Lit TotalKMMapMod.__default.DefaultV))]|))
(assert (! (=> |b27[funType:PagedBetree.ChildMap.mapp]| (= (type (PagedBetree.ChildMap.mapp (PagedBetree.BetreeNode.children this@@248))) (IMapType BoxType BoxType))) :named |0x7fe12996e318-funType:PagedBetree.ChildMap.mapp[arg0@@372=(PagedBetree.BetreeNode.children this@@248)]| :named |0x7fe12996e290-funType:PagedBetree.ChildMap.mapp[arg0@@372=(PagedBetree.BetreeNode.children this@@248)]|))
...
(assert (! (=> |b22[typeInv:IMapTypeInv0]| (= (IMapTypeInv0 (IMapType BoxType BoxType)) BoxType)) :named |0x7fe129972b88-typeInv:IMapTypeInv0[arg1@@12=BoxType,arg0@@46=BoxType]| :named |0x7fe129972db0-typeInv:IMapTypeInv0[arg1@@12=BoxType,arg0@@46=BoxType]|))
...
(assert (! (=> |b34[Buffersidfy.15:20!1659]| (=> (and (= (type |key#0@@61|) (SeqType BoxType)) (or (|Buffers.__default.AnyKey#canCall| |key#0@@61|) ($Is |key#0@@61| Tclass.KeyType.Key))) (= (Buffers.__default.AnyKey |key#0@@61|) (U_2_bool (Lit (bool_2_U true)))))) :named |0x7fe12997fc18-Buffersidfy.15:20!1659[key#0@@51=key#0@@61]|))
(assert (! (=> |b31[unknown.0:0!1121]| (or (not (and (= (type this@@248) DatatypeTypeType) (PagedBetree.BetreeNode.BetreeNode_q this@@248))) (and (= (type (|a#6#0#0@@0!1349!2| this@@248)) DatatypeTypeType) (= (type (|a#6#1#0@@0!1349!1| this@@248)) DatatypeTypeType) (= this@@248 (|#PagedBetree.BetreeNode.BetreeNode| (|a#6#0#0@@0!1349!2| this@@248) (|a#6#1#0@@0!1349!1| this@@248)))))) :named |0x7fe129960978-unknown.0:0!1121[d@@43=this@@248]|))
...
(assert (! (=> |b32[PagedBetreeidfy.69:5!1156]| (=> (and (= (type (|a#6#0#0@@0!1349!2| this@@248)) DatatypeTypeType) (= (type (|a#6#1#0@@0!1349!1| this@@248)) DatatypeTypeType)) (= (PagedBetree.BetreeNode.children (|#PagedBetree.BetreeNode.BetreeNode| (|a#6#0#0@@0!1349!2| this@@248) (|a#6#1#0@@0!1349!1| this@@248))) (|a#6#1#0@@0!1349!1| this@@248)))) :named |0x7fe12996d9c8-PagedBetreeidfy.69:5!1156[a#12#1#0=(a#6#1#0@@0!1349!1 this@@248),a#12#0#0=(a#6#0#0@@0!1349!2 this@@248)]|))
(assert (! (=> |b28[PagedBetreeidfy.49:15]| (=> (and (= (type $LZ) LayerTypeType) (= (type (PagedBetree.BetreeNode.children this@@248)) DatatypeTypeType)) (= (PagedBetree.ChildMap.WF ($LS $LZ) (PagedBetree.BetreeNode.children this@@248)) (PagedBetree.ChildMap.WF $LZ (PagedBetree.BetreeNode.children this@@248))))) :named |0x7fe12996e1c0-PagedBetreeidfy.49:15[$ly=$LZ,this=(PagedBetree.BetreeNode.children this@@248)]| :named |0x7fe12996e1a8-PagedBetreeidfy.49:15[$ly=$LZ,this=(PagedBetree.BetreeNode.children this@@248)]|))
