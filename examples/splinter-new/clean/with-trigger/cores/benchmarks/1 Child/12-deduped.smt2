...
(assert (forall ((this T@U)($ly T@U)) (! (=> (and (= (type $ly) LayerTypeType) (= (type this) DatatypeTypeType)) (= (PagedBetree.ChildMap.WF ($LS $ly) this) (PagedBetree.ChildMap.WF $ly this))) :qid |PagedBetreeidfy.49:15| :skolemid |1329| :pattern ( (PagedBetree.ChildMap.WF ($LS $ly) this)))))
