...
(assert (forall ((|a#5#1#0@@3| T@U)(|a#5#2#0@@0| Int)(|a#5#0#0@@3| T@U)) (! (=> (and (= (type |a#5#0#0@@3|) DatatypeTypeType) (= (type |a#5#1#0@@3|) (SeqType BoxType))) (= (PivotBetree.Path.node (|#PivotBetree.Path.Path| |a#5#0#0@@3| |a#5#1#0@@3| |a#5#2#0@@0|)) |a#5#0#0@@3|)) :qid |PivotBetreeidfy.462:24!2754| :skolemid |2049| :pattern ( (|#PivotBetree.Path.Path| |a#5#0#0@@3| |a#5#1#0@@3| |a#5#2#0@@0|)))))
