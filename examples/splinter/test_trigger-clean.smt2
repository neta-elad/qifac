  ...
  (! (let ((a!1 (not (and (= (type f@@13) HandleTypeType)
           ...
           (a!2 (forall ((h@@24 T@U) (bx0@@10 T@U))
                  (! (=> (and (= (type h@@24)
                     ...
                     :skolemid |738|
                     :qid |DafnyPreludebpl.545:12!223|)))
           ...
           (a!2 (forall ((h@@36 T@U) (bx0@@24 T@U) (bx1@@10 T@U))
                  (! (=> (and (= (type h@@36)
                     ...
                     :pattern ((Apply2 t0@@57
                                       ...
                                       bx1@@10))
                     :skolemid |826|
                     :qid |DafnyPreludebpl.545:12!255|)))
    ...
    (forall ((|keys#0@@1| T@U))
      (! (let ((a!1 (and (= (type |keys#0@@1|) (MapType0Type BoxType boolType))
               ...
               (a!4 (U_2_bool (MapType0Select |keys#0@@1|
                                              ($Box (|k#0@@2!1032!121|
                                                      |keys#0@@1|))))))
         (let ((a!5 (=> (and ($Is (|k#0@@2!1032!121| |keys#0@@1|)
                                  Tclass.Common.Key)
                             (Common.__default.AnyKey
                               (|k#0@@2!1032!121| |keys#0@@1|)))
                        a!4)))
         (let ((a!6 (=> (= (type (|k#0@@2!1032!121| |keys#0@@1|))
                           (SeqType BoxType))
                        a!5)))
         (let ((a!7 (and a!2
    ...
    (forall ((|keys#0@@2| T@U))
      (! (let ((a!1 (and (= (type |keys#0@@2|) (MapType0Type BoxType boolType))
         ...
         (let ((a!4 (or (not (Common.__default.TotalSet (Lit |keys#0@@2|))) a!3))
               (a!6 (=> (and ($Is (|k#1@@2!1035!122| |keys#0@@2|)
                                  Tclass.Common.Key)
                             (Common.__default.AnyKey
                               (|k#1@@2!1035!122| |keys#0@@2|)))
                        a!5)))
         (let ((a!7 (=> (= (type (|k#1@@2!1035!122| |keys#0@@2|))
                           (SeqType BoxType))
                        a!6)))
         (let ((a!8 (and a!2
                         a!4
...
(assert ($IsAlloc this@@27 Tclass.Test.QueryReceipt $Heap))
(assert (let ((a!1 (forall (($f@@11 T@U) ($o@@25 T@U))
             (! (let ((a!1 (= (type $f@@11)
...
(assert (let ((a!1 (= (type $f@@11!1008!124)
              (FieldType (FieldTypeInv0 (type $f@@11!1008!124))))))
(let ((a!2 (=> (and (= (type $o@@25!1008!123) refType) a!1 false)
...
(assert (let ((a!1 (not (=> (= (ControlFlow 0 39141) (- 0 56539)) |b$reqreads#0@0|)))
      (a!2 (not (=> (= (ControlFlow 0 39141) (- 0 56540)) |b$reqreads#1@0|)))
      (a!3 (not (=> (= (ControlFlow 0 39141) 39145) true)))
      (a!4 (and (<= 0 |i#0@@9|)
                (< |i#0@@9| (|Seq#Length| (Test.QueryReceipt.lines this@@27)))))
      (a!6 (Test.QueryReceiptLine.QueryReceiptLine_q
             ($Unbox DatatypeTypeType
                     (|Seq#Index| (Test.QueryReceipt.lines this@@27) |i#0@@9|))))
      (a!7 (Test.QueryReceiptLine.node
             ($Unbox DatatypeTypeType
                     (|Seq#Index| (Test.QueryReceipt.lines this@@27) |i#0@@9|)))))
(let ((a!5 (not (=> (= (ControlFlow 0 39147) (- 0 56573)) a!4)))
      (a!8 (not (=> (= (ControlFlow 0 39147) (- 0 56605))
                    (Test.BetreeNode.BetreeNode_q a!7))))
      (a!9 (|Common.__default.TotalSet#canCall|
             (|IMap#Domain| (Test.ChildMap.mapp (Test.BetreeNode.children a!7)))))
      (a!10 (Common.__default.TotalSet
              (|IMap#Domain| (Test.ChildMap.mapp (Test.BetreeNode.children a!7)))))
      (a!11 (MapType0Select (|IMap#Domain| (Test.ChildMap.mapp
                                             (Test.BetreeNode.children a!7)))
                            ($Box |k#0@@3!1010!127|)))
      (a!14 (MapType0Select (|IMap#Elements| (Test.ChildMap.mapp
                                               (Test.BetreeNode.children a!7)))
                            ($Box |k#1@@3!1012!128|)))
      (a!18 (and (Test.ChildMap.WF ($LS ($LS $LZ))
                                   (Test.BetreeNode.children a!7))
                 (Test.QueryReceipt.QueryReceipt_q this@@27)))
      (a!19 (MapType0Select (|IMap#Domain| (Test.ChildMap.mapp
                                             (Test.BetreeNode.children a!7)))
                            ($Box (Test.QueryReceipt.key this@@27)))))
(let ((a!12 (=> (= (type |k#0@@3!1010!127|) (SeqType BoxType))
                (=> (and ($Is |k#0@@3!1010!127| Tclass.Common.Key)
                         (Common.__default.AnyKey |k#0@@3!1010!127|))
                    (U_2_bool a!11))))
      (a!15 (=> (and ($Is |k#1@@3!1012!128| Tclass.Common.Key)
                     (Common.__default.AnyKey |k#1@@3!1012!128|))
                (Test.BetreeNode.WF
                  ($LS ($LS $LZ))
                  ($Unbox DatatypeTypeType a!14))))
      (a!20 (=> (and (Test.QueryReceipt.QueryReceipt_q this@@27)
                     (= (ControlFlow 0 39147) (- 0 57103)))
                (U_2_bool a!19))))
(let ((a!13 (and (= (ControlFlow 0 39147) (- 0 56701))
                 (|Test.ChildMap.WF#canCall| (Test.BetreeNode.children a!7))
                 (not (Test.ChildMap.WF ($LS $LZ)
                                        (Test.BetreeNode.children a!7)))
                 a!9
                 (not a!10)
                 (not a!12)))
      (a!16 (not (=> (= (type |k#1@@3!1012!128|) (SeqType BoxType)) a!15)))
      (a!21 (=> (Test.BetreeNode.BetreeNode_q a!7)
                (=> (Test.ChildMap.ChildMap_q (Test.BetreeNode.children a!7))
                    a!20))))
(let ((a!17 (and (= (ControlFlow 0 39147) (- 0 56869))
                 (|Test.ChildMap.WF#canCall| (Test.BetreeNode.children a!7))
                 (not (Test.ChildMap.WF ($LS $LZ)
                                        (Test.BetreeNode.children a!7)))
                 a!16))
      (a!22 (and (=> (= (ControlFlow 0 39147) (- 0 57065))
                     (Test.BetreeNode.BetreeNode_q a!7))
                 a!21)))
(let ((a!23 (and (=> (= (ControlFlow 0 39147) (- 0 57033)) a!4)
                 (=> a!4 (=> a!6 a!22)))))
(let ((a!24 (and (Test.BetreeNode.BetreeNode_q a!7)
                 ($IsAlloc (Test.BetreeNode.children a!7)
                           Tclass.Test.ChildMap
                           $Heap)
                 (|Test.ChildMap.WF#canCall| (Test.BetreeNode.children a!7))
                 (Test.QueryReceipt.QueryReceipt_q this@@27)
                 a!6
                 (|Test.ChildMap.WF#canCall| (Test.BetreeNode.children a!7))
                 (or a!13 a!17 (not (=> a!18 a!23))))))
(let ((a!25 (and (= (ControlFlow 0 39141) 39147)
                 (= $_Frame@0 (|lambda#11| null $Heap alloc false))
                 (Test.QueryReceipt.QueryReceipt_q this@@27)
                 (or a!5 (and a!6 (or a!8 a!24))))))
(let ((a!26 (and |b$reqreads#0@0| (or a!2 (and |b$reqreads#1@0| (or a!3 a!25))))))
  (or a!1 a!26)))))))))))
(check-sat)
