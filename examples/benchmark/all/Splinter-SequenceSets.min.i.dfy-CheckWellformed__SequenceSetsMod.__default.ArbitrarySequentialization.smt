...
(assert (not
 (=> (= (ControlFlow 0 0) 48819) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 48802) (- 0 49627)) (= (|Seq#Length| |b#4|) (|Set#Card| |a#0@@15|))) (=> (= (|Seq#Length| |b#4|) (|Set#Card| |a#0@@15|)) (=> (= (ControlFlow 0 48802) (- 0 49637)) (|Set#Equal| (SequenceSetsMod.__default.Members SequenceSetsMod._default.ArbitrarySequentialization$T@@6 |b#4|) |a#0@@15|))))))
(let ((anon8_correct  (=> (= (SequenceSetsMod.__default.ArbitrarySequentialization SequenceSetsMod._default.ArbitrarySequentialization$T@@6 ($LS $LZ) |a#0@@15|) |b#4|) (and (=> (= (ControlFlow 0 35027) (- 0 49626)) |b$reqreads#0@1|) (=> |b$reqreads#0@1| (=> (= (ControlFlow 0 35027) 48802) GeneratedUnifiedExit_correct))))))
(let ((anon7_correct  (and (=> (= (ControlFlow 0 35025) (- 0 49075)) (exists ((|x#3| T@U) ) (!  (and (= (type |x#3|) BoxType) (and ($IsBox |x#3| SequenceSetsMod._default.ArbitrarySequentialization$T@@6) (U_2_bool (MapType0Select |a#0@@15| |x#3|))))
 :qid |SequenceSetsminidfy.21:11|
 :skolemid |905|
 :no-pattern (type |x#3|)
