...
(assert (= (type Tclass.SequenceSetsMod.__default) TyType))
(assert (= (Tag Tclass.SequenceSetsMod.__default) Tagclass.SequenceSetsMod.__default))
(assert (= (TagFamily Tclass.SequenceSetsMod.__default) tytagFamily$_default))
(assert (forall ((bx@@52 T@U) ) (!  (=> (and (= (type bx@@52) BoxType) ($IsBox bx@@52 Tclass.SequenceSetsMod.__default)) (and (= ($Box ($Unbox refType bx@@52)) bx@@52) ($Is ($Unbox refType bx@@52) Tclass.SequenceSetsMod.__default)))
 :qid |unknown.0:0|
 :skolemid |884|
 :pattern ( ($IsBox bx@@52 Tclass.SequenceSetsMod.__default))
)))
(assert (forall (($o@@9 T@U) ) (!  (=> (= (type $o@@9) refType) (= ($Is $o@@9 Tclass.SequenceSetsMod.__default)  (or (= $o@@9 null) (= (dtype $o@@9) Tclass.SequenceSetsMod.__default))))
 :qid |unknown.0:0|
 :skolemid |885|
 :pattern ( ($Is $o@@9 Tclass.SequenceSetsMod.__default))
)))
(assert (forall (($o@@10 T@U) ($h@@18 T@U) ) (!  (=> (and (= (type $o@@10) refType) (= (type $h@@18) (MapType0Type refType MapType1Type))) (= ($IsAlloc $o@@10 Tclass.SequenceSetsMod.__default $h@@18)  (or (= $o@@10 null) (U_2_bool (MapType1Select (MapType0Select $h@@18 $o@@10) alloc)))))
 :qid |unknown.0:0|
 :skolemid |886|
 :pattern ( ($IsAlloc $o@@10 Tclass.SequenceSetsMod.__default $h@@18))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((SequenceSetsMod._default.SequenceSubset$T T@U) (|a#0@@1| T@U) (|b#0@@1| T@U) ) (!  (=> (and (and (and (= (type SequenceSetsMod._default.SequenceSubset$T) TyType) (= (type |a#0@@1|) (SeqType BoxType))) (= (type |b#0@@1|) (SeqType BoxType))) (or (|SequenceSetsMod.__default.SequenceSubset#canCall| SequenceSetsMod._default.SequenceSubset$T |a#0@@1| |b#0@@1|) (and (not (= 2 $FunctionContextHeight)) (and ($Is |a#0@@1| (TSeq SequenceSetsMod._default.SequenceSubset$T)) ($Is |b#0@@1| (TSeq SequenceSetsMod._default.SequenceSubset$T)))))) true)
 :qid |unknown.0:0|
 :skolemid |887|
 :pattern ( (SequenceSetsMod.__default.SequenceSubset SequenceSetsMod._default.SequenceSubset$T |a#0@@1| |b#0@@1|))
))))
(assert (forall ((SequenceSetsMod._default.SequenceSubset$T@@0 T@U) (|a#0@@2| T@U) (|b#0@@2| T@U) ) (!  (=> (and (and (and (= (type SequenceSetsMod._default.SequenceSubset$T@@0) TyType) (= (type |a#0@@2|) (SeqType BoxType))) (= (type |b#0@@2|) (SeqType BoxType))) (and ($Is |a#0@@2| (TSeq SequenceSetsMod._default.SequenceSubset$T@@0)) ($Is |b#0@@2| (TSeq SequenceSetsMod._default.SequenceSubset$T@@0)))) (= (|SequenceSetsMod.__default.SequenceSubset#requires| SequenceSetsMod._default.SequenceSubset$T@@0 |a#0@@2| |b#0@@2|) true))
 :qid |unknown.0:0|
 :skolemid |888|
 :pattern ( (|SequenceSetsMod.__default.SequenceSubset#requires| SequenceSetsMod._default.SequenceSubset$T@@0 |a#0@@2| |b#0@@2|))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((SequenceSetsMod._default.SequenceSubset$T@@1 T@U) (|a#0@@3| T@U) (|b#0@@3| T@U) ) (!  (=> (and (and (and (= (type SequenceSetsMod._default.SequenceSubset$T@@1) TyType) (= (type |a#0@@3|) (SeqType BoxType))) (= (type |b#0@@3|) (SeqType BoxType))) (or (|SequenceSetsMod.__default.SequenceSubset#canCall| SequenceSetsMod._default.SequenceSubset$T@@1 |a#0@@3| |b#0@@3|) (and (not (= 2 $FunctionContextHeight)) (and ($Is |a#0@@3| (TSeq SequenceSetsMod._default.SequenceSubset$T@@1)) ($Is |b#0@@3| (TSeq SequenceSetsMod._default.SequenceSubset$T@@1)))))) (= (SequenceSetsMod.__default.SequenceSubset SequenceSetsMod._default.SequenceSubset$T@@1 |a#0@@3| |b#0@@3|) (forall ((|i#0| Int) ) (!  (=> (and (INTERNAL_le_boogie 0 |i#0|) (INTERNAL_lt_boogie |i#0| (|Seq#Length| |a#0@@3|))) (|Seq#Contains| |b#0@@3| (|Seq#Index| |a#0@@3| |i#0|)))
 :qid |SequenceSetsbrokenidfy.5:12|
 :skolemid |889|
 :pattern ( (|Seq#Index| |a#0@@3| |i#0|))
))))
 :qid |unknown.0:0|
 :skolemid |890|
 :pattern ( (SequenceSetsMod.__default.SequenceSubset SequenceSetsMod._default.SequenceSubset$T@@1 |a#0@@3| |b#0@@3|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((SequenceSetsMod._default.SequenceSubset$T@@2 T@U) (|a#0@@4| T@U) (|b#0@@4| T@U) ) (!  (=> (and (and (and (= (type SequenceSetsMod._default.SequenceSubset$T@@2) TyType) (= (type |a#0@@4|) (SeqType BoxType))) (= (type |b#0@@4|) (SeqType BoxType))) (or (|SequenceSetsMod.__default.SequenceSubset#canCall| SequenceSetsMod._default.SequenceSubset$T@@2 (Lit |a#0@@4|) (Lit |b#0@@4|)) (and (not (= 2 $FunctionContextHeight)) (and ($Is |a#0@@4| (TSeq SequenceSetsMod._default.SequenceSubset$T@@2)) ($Is |b#0@@4| (TSeq SequenceSetsMod._default.SequenceSubset$T@@2)))))) (= (SequenceSetsMod.__default.SequenceSubset SequenceSetsMod._default.SequenceSubset$T@@2 (Lit |a#0@@4|) (Lit |b#0@@4|)) (forall ((|i#1| Int) ) (!  (=> (and (INTERNAL_le_boogie 0 |i#1|) (INTERNAL_lt_boogie |i#1| (|Seq#Length| (Lit |a#0@@4|)))) (|Seq#Contains| |b#0@@4| (|Seq#Index| (Lit |a#0@@4|) |i#1|)))
 :qid |SequenceSetsbrokenidfy.5:12|
 :skolemid |891|
 :pattern ( (|Seq#Index| |a#0@@4| |i#1|))
))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |892|
 :pattern ( (SequenceSetsMod.__default.SequenceSubset SequenceSetsMod._default.SequenceSubset$T@@2 (Lit |a#0@@4|) (Lit |b#0@@4|)))
))))
(assert (forall ((arg0@@170 T@U) (arg1@@80 T@U) ) (! (= (type (SequenceSetsMod.__default.Members arg0@@170 arg1@@80)) (MapType0Type BoxType boolType))
 :qid |funType:SequenceSetsMod.__default.Members|
 :pattern ( (SequenceSetsMod.__default.Members arg0@@170 arg1@@80))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((SequenceSetsMod._default.Members$T T@U) (|a#0@@5| T@U) ) (!  (=> (and (and (= (type SequenceSetsMod._default.Members$T) TyType) (= (type |a#0@@5|) (SeqType BoxType))) (or (|SequenceSetsMod.__default.Members#canCall| SequenceSetsMod._default.Members$T |a#0@@5|) (and (not (= 0 $FunctionContextHeight)) ($Is |a#0@@5| (TSeq SequenceSetsMod._default.Members$T))))) ($Is (SequenceSetsMod.__default.Members SequenceSetsMod._default.Members$T |a#0@@5|) (TSet SequenceSetsMod._default.Members$T)))
 :qid |unknown.0:0|
 :skolemid |894|
 :pattern ( (SequenceSetsMod.__default.Members SequenceSetsMod._default.Members$T |a#0@@5|))
))))
(assert (forall ((SequenceSetsMod._default.Members$T@@0 T@U) (|a#0@@6| T@U) ) (!  (=> (and (and (= (type SequenceSetsMod._default.Members$T@@0) TyType) (= (type |a#0@@6|) (SeqType BoxType))) ($Is |a#0@@6| (TSeq SequenceSetsMod._default.Members$T@@0))) (= (|SequenceSetsMod.__default.Members#requires| SequenceSetsMod._default.Members$T@@0 |a#0@@6|) true))
 :qid |unknown.0:0|
 :skolemid |895|
 :pattern ( (|SequenceSetsMod.__default.Members#requires| SequenceSetsMod._default.Members$T@@0 |a#0@@6|))
)))
(assert (forall ((arg0@@171 T@U) (arg1@@81 T@U) ) (! (= (type (|lambda#2| arg0@@171 arg1@@81)) (MapType0Type BoxType boolType))
 :qid |funType:lambda#2|
 :pattern ( (|lambda#2| arg0@@171 arg1@@81))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((SequenceSetsMod._default.Members$T@@1 T@U) (|a#0@@7| T@U) ) (!  (=> (and (and (= (type SequenceSetsMod._default.Members$T@@1) TyType) (= (type |a#0@@7|) (SeqType BoxType))) (or (|SequenceSetsMod.__default.Members#canCall| SequenceSetsMod._default.Members$T@@1 |a#0@@7|) (and (not (= 0 $FunctionContextHeight)) ($Is |a#0@@7| (TSeq SequenceSetsMod._default.Members$T@@1))))) (= (SequenceSetsMod.__default.Members SequenceSetsMod._default.Members$T@@1 |a#0@@7|) (|lambda#2| SequenceSetsMod._default.Members$T@@1 |a#0@@7|)))
 :qid |unknown.0:0|
 :skolemid |896|
 :pattern ( (SequenceSetsMod.__default.Members SequenceSetsMod._default.Members$T@@1 |a#0@@7|))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((SequenceSetsMod._default.Members$T@@2 T@U) (|a#0@@8| T@U) ) (!  (=> (and (and (= (type SequenceSetsMod._default.Members$T@@2) TyType) (= (type |a#0@@8|) (SeqType BoxType))) (or (|SequenceSetsMod.__default.Members#canCall| SequenceSetsMod._default.Members$T@@2 (Lit |a#0@@8|)) (and (not (= 0 $FunctionContextHeight)) ($Is |a#0@@8| (TSeq SequenceSetsMod._default.Members$T@@2))))) (= (SequenceSetsMod.__default.Members SequenceSetsMod._default.Members$T@@2 (Lit |a#0@@8|)) (|lambda#2| SequenceSetsMod._default.Members$T@@2 |a#0@@8|)))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |897|
 :pattern ( (SequenceSetsMod.__default.Members SequenceSetsMod._default.Members$T@@2 (Lit |a#0@@8|)))
))))
(assert (forall ((arg0@@172 T@U) (arg1@@82 T@U) (arg2@@32 T@U) ) (! (= (type (SequenceSetsMod.__default.ArbitrarySequentialization arg0@@172 arg1@@82 arg2@@32)) (SeqType BoxType))
 :qid |funType:SequenceSetsMod.__default.ArbitrarySequentialization|
 :pattern ( (SequenceSetsMod.__default.ArbitrarySequentialization arg0@@172 arg1@@82 arg2@@32))
)))
(assert (forall ((SequenceSetsMod._default.ArbitrarySequentialization$T T@U) ($ly T@U) (|a#0@@9| T@U) ) (!  (=> (and (and (= (type SequenceSetsMod._default.ArbitrarySequentialization$T) TyType) (= (type $ly) LayerTypeType)) (= (type |a#0@@9|) (MapType0Type BoxType boolType))) (= (SequenceSetsMod.__default.ArbitrarySequentialization SequenceSetsMod._default.ArbitrarySequentialization$T ($LS $ly) |a#0@@9|) (SequenceSetsMod.__default.ArbitrarySequentialization SequenceSetsMod._default.ArbitrarySequentialization$T $ly |a#0@@9|)))
 :qid |unknown.0:0|
 :skolemid |898|
 :pattern ( (SequenceSetsMod.__default.ArbitrarySequentialization SequenceSetsMod._default.ArbitrarySequentialization$T ($LS $ly) |a#0@@9|))
)))
(assert  (and (forall ((arg0@@173 T@U) ) (! (= (type (AsFuelBottom arg0@@173)) LayerTypeType)
 :qid |funType:AsFuelBottom|
 :pattern ( (AsFuelBottom arg0@@173))
)) (= (type $LZ) LayerTypeType)))
(assert (forall ((SequenceSetsMod._default.ArbitrarySequentialization$T@@0 T@U) ($ly@@0 T@U) (|a#0@@10| T@U) ) (!  (=> (and (and (= (type SequenceSetsMod._default.ArbitrarySequentialization$T@@0) TyType) (= (type $ly@@0) LayerTypeType)) (= (type |a#0@@10|) (MapType0Type BoxType boolType))) (= (SequenceSetsMod.__default.ArbitrarySequentialization SequenceSetsMod._default.ArbitrarySequentialization$T@@0 $ly@@0 |a#0@@10|) (SequenceSetsMod.__default.ArbitrarySequentialization SequenceSetsMod._default.ArbitrarySequentialization$T@@0 $LZ |a#0@@10|)))
 :qid |unknown.0:0|
 :skolemid |899|
 :pattern ( (SequenceSetsMod.__default.ArbitrarySequentialization SequenceSetsMod._default.ArbitrarySequentialization$T@@0 (AsFuelBottom $ly@@0) |a#0@@10|))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((SequenceSetsMod._default.ArbitrarySequentialization$T@@1 T@U) ($ly@@1 T@U) (|a#0@@11| T@U) ) (!  (=> (and (and (and (= (type SequenceSetsMod._default.ArbitrarySequentialization$T@@1) TyType) (= (type $ly@@1) LayerTypeType)) (= (type |a#0@@11|) (MapType0Type BoxType boolType))) (or (|SequenceSetsMod.__default.ArbitrarySequentialization#canCall| SequenceSetsMod._default.ArbitrarySequentialization$T@@1 |a#0@@11|) (and (not (= 1 $FunctionContextHeight)) ($Is |a#0@@11| (TSet SequenceSetsMod._default.ArbitrarySequentialization$T@@1))))) (and (and (= (|Seq#Length| (SequenceSetsMod.__default.ArbitrarySequentialization SequenceSetsMod._default.ArbitrarySequentialization$T@@1 $ly@@1 |a#0@@11|)) (|Set#Card| |a#0@@11|)) (|Set#Equal| (SequenceSetsMod.__default.Members SequenceSetsMod._default.ArbitrarySequentialization$T@@1 (SequenceSetsMod.__default.ArbitrarySequentialization SequenceSetsMod._default.ArbitrarySequentialization$T@@1 $ly@@1 |a#0@@11|)) |a#0@@11|)) ($Is (SequenceSetsMod.__default.ArbitrarySequentialization SequenceSetsMod._default.ArbitrarySequentialization$T@@1 $ly@@1 |a#0@@11|) (TSeq SequenceSetsMod._default.ArbitrarySequentialization$T@@1))))
 :qid |unknown.0:0|
 :skolemid |900|
 :pattern ( (SequenceSetsMod.__default.ArbitrarySequentialization SequenceSetsMod._default.ArbitrarySequentialization$T@@1 $ly@@1 |a#0@@11|))
))))
(assert (forall ((SequenceSetsMod._default.ArbitrarySequentialization$T@@2 T@U) ($ly@@2 T@U) ($Heap T@U) (|a#0@@12| T@U) ) (!  (=> (and (and (and (and (= (type SequenceSetsMod._default.ArbitrarySequentialization$T@@2) TyType) (= (type $ly@@2) LayerTypeType)) (= (type $Heap) (MapType0Type refType MapType1Type))) (= (type |a#0@@12|) (MapType0Type BoxType boolType))) (and ($IsGoodHeap $Heap) ($Is |a#0@@12| (TSet SequenceSetsMod._default.ArbitrarySequentialization$T@@2)))) (= (|SequenceSetsMod.__default.ArbitrarySequentialization#requires| SequenceSetsMod._default.ArbitrarySequentialization$T@@2 $ly@@2 |a#0@@12|) true))
 :qid |unknown.0:0|
 :skolemid |901|
 :pattern ( (|SequenceSetsMod.__default.ArbitrarySequentialization#requires| SequenceSetsMod._default.ArbitrarySequentialization$T@@2 $ly@@2 |a#0@@12|) ($IsGoodHeap $Heap))
)))
(assert (forall ((arg0@@174 T@U) (arg1@@83 T@U) ) (! (= (type (|$let#0_x| arg0@@174 arg1@@83)) BoxType)
 :qid |funType:$let#0_x|
 :pattern ( (|$let#0_x| arg0@@174 arg1@@83))
)))
(assert (forall ((SequenceSetsMod._default.ArbitrarySequentialization$T@@3 T@U) (a@@104 T@U) ) (!  (=> (and (and (= (type SequenceSetsMod._default.ArbitrarySequentialization$T@@3) TyType) (= (type a@@104) (MapType0Type BoxType boolType))) (|$let#0$canCall| SequenceSetsMod._default.ArbitrarySequentialization$T@@3 a@@104)) (U_2_bool (MapType0Select a@@104 (|$let#0_x| SequenceSetsMod._default.ArbitrarySequentialization$T@@3 a@@104))))
 :qid |SequenceSetsbrokenidfy.21:7|
 :skolemid |902|
 :pattern ( (|$let#0_x| SequenceSetsMod._default.ArbitrarySequentialization$T@@3 a@@104))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((SequenceSetsMod._default.ArbitrarySequentialization$T@@4 T@U) ($ly@@3 T@U) ($Heap@@0 T@U) (|a#0@@13| T@U) ) (!  (=> (and (and (and (and (= (type SequenceSetsMod._default.ArbitrarySequentialization$T@@4) TyType) (= (type $ly@@3) LayerTypeType)) (= (type $Heap@@0) (MapType0Type refType MapType1Type))) (= (type |a#0@@13|) (MapType0Type BoxType boolType))) (or (|SequenceSetsMod.__default.ArbitrarySequentialization#canCall| SequenceSetsMod._default.ArbitrarySequentialization$T@@4 |a#0@@13|) (and (not (= 1 $FunctionContextHeight)) (and ($IsGoodHeap $Heap@@0) ($Is |a#0@@13| (TSet SequenceSetsMod._default.ArbitrarySequentialization$T@@4)))))) (and (=> (not (= (|Set#Card| |a#0@@13|) (LitInt 0))) (and (|$let#0$canCall| SequenceSetsMod._default.ArbitrarySequentialization$T@@4 |a#0@@13|) (|SequenceSetsMod.__default.ArbitrarySequentialization#canCall| SequenceSetsMod._default.ArbitrarySequentialization$T@@4 (|Set#Difference| |a#0@@13| (|Set#UnionOne| (|Set#Empty| BoxType) (|$let#0_x| SequenceSetsMod._default.ArbitrarySequentialization$T@@4 |a#0@@13|)))))) (= (SequenceSetsMod.__default.ArbitrarySequentialization SequenceSetsMod._default.ArbitrarySequentialization$T@@4 ($LS $ly@@3) |a#0@@13|) (ite (= (|Set#Card| |a#0@@13|) (LitInt 0)) (|Seq#Empty| BoxType) (let ((|x#0@@1| (|$let#0_x| SequenceSetsMod._default.ArbitrarySequentialization$T@@4 |a#0@@13|)))
(let ((|b#0@@5| (|Seq#Append| (SequenceSetsMod.__default.ArbitrarySequentialization SequenceSetsMod._default.ArbitrarySequentialization$T@@4 $ly@@3 (|Set#Difference| |a#0@@13| (|Set#UnionOne| (|Set#Empty| BoxType) |x#0@@1|))) (|Seq#Build| (|Seq#Empty| BoxType) |x#0@@1|))))
|b#0@@5|))))))
 :qid |unknown.0:0|
 :skolemid |903|
 :pattern ( (SequenceSetsMod.__default.ArbitrarySequentialization SequenceSetsMod._default.ArbitrarySequentialization$T@@4 ($LS $ly@@3) |a#0@@13|) ($IsGoodHeap $Heap@@0))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((SequenceSetsMod._default.ArbitrarySequentialization$T@@5 T@U) ($ly@@4 T@U) ($Heap@@1 T@U) (|a#0@@14| T@U) ) (!  (=> (and (and (and (and (= (type SequenceSetsMod._default.ArbitrarySequentialization$T@@5) TyType) (= (type $ly@@4) LayerTypeType)) (= (type $Heap@@1) (MapType0Type refType MapType1Type))) (= (type |a#0@@14|) (MapType0Type BoxType boolType))) (or (|SequenceSetsMod.__default.ArbitrarySequentialization#canCall| SequenceSetsMod._default.ArbitrarySequentialization$T@@5 (Lit |a#0@@14|)) (and (not (= 1 $FunctionContextHeight)) (and ($IsGoodHeap $Heap@@1) ($Is |a#0@@14| (TSet SequenceSetsMod._default.ArbitrarySequentialization$T@@5)))))) (and (=> (not (= (|Set#Card| (Lit |a#0@@14|)) (LitInt 0))) (and (|$let#0$canCall| SequenceSetsMod._default.ArbitrarySequentialization$T@@5 (Lit |a#0@@14|)) (|SequenceSetsMod.__default.ArbitrarySequentialization#canCall| SequenceSetsMod._default.ArbitrarySequentialization$T@@5 (|Set#Difference| |a#0@@14| (|Set#UnionOne| (|Set#Empty| BoxType) (|$let#0_x| SequenceSetsMod._default.ArbitrarySequentialization$T@@5 (Lit |a#0@@14|))))))) (= (SequenceSetsMod.__default.ArbitrarySequentialization SequenceSetsMod._default.ArbitrarySequentialization$T@@5 ($LS $ly@@4) (Lit |a#0@@14|)) (ite (= (|Set#Card| (Lit |a#0@@14|)) (LitInt 0)) (|Seq#Empty| BoxType) (let ((|x#1| (|$let#0_x| SequenceSetsMod._default.ArbitrarySequentialization$T@@5 (Lit |a#0@@14|))))
(let ((|b#2| (|Seq#Append| (SequenceSetsMod.__default.ArbitrarySequentialization SequenceSetsMod._default.ArbitrarySequentialization$T@@5 ($LS $ly@@4) (|Set#Difference| |a#0@@14| (|Set#UnionOne| (|Set#Empty| BoxType) |x#1|))) (|Seq#Build| (|Seq#Empty| BoxType) |x#1|))))
|b#2|))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |904|
 :pattern ( (SequenceSetsMod.__default.ArbitrarySequentialization SequenceSetsMod._default.ArbitrarySequentialization$T@@5 ($LS $ly@@4) (Lit |a#0@@14|)) ($IsGoodHeap $Heap@@1))
))))
(assert  (and (and (and (and (and (and (and (forall ((arg0@@175 T@T) (arg1@@84 T@T) ) (! (= (Ctor (MapType4Type arg0@@175 arg1@@84)) 26)
 :qid |ctor:MapType4Type|
)) (forall ((arg0@@176 T@T) (arg1@@85 T@T) ) (! (= (MapType4TypeInv0 (MapType4Type arg0@@176 arg1@@85)) arg0@@176)
 :qid |typeInv:MapType4TypeInv0|
 :pattern ( (MapType4Type arg0@@176 arg1@@85))
))) (forall ((arg0@@177 T@T) (arg1@@86 T@T) ) (! (= (MapType4TypeInv1 (MapType4Type arg0@@177 arg1@@86)) arg1@@86)
 :qid |typeInv:MapType4TypeInv1|
 :pattern ( (MapType4Type arg0@@177 arg1@@86))
))) (forall ((arg0@@178 T@U) (arg1@@87 T@U) (arg2@@33 T@U) ) (! (let ((aVar1@@4 (MapType4TypeInv1 (type arg0@@178))))
(= (type (MapType4Select arg0@@178 arg1@@87 arg2@@33)) aVar1@@4))
 :qid |funType:MapType4Select|
 :pattern ( (MapType4Select arg0@@178 arg1@@87 arg2@@33))
))) (forall ((arg0@@179 T@U) (arg1@@88 T@U) (arg2@@34 T@U) (arg3@@12 T@U) ) (! (let ((aVar1@@5 (type arg3@@12)))
(let ((aVar0@@2 (type arg1@@88)))
(= (type (MapType4Store arg0@@179 arg1@@88 arg2@@34 arg3@@12)) (MapType4Type aVar0@@2 aVar1@@5))))
 :qid |funType:MapType4Store|
 :pattern ( (MapType4Store arg0@@179 arg1@@88 arg2@@34 arg3@@12))
 ...
 :weight 0
)))) (forall ((arg0@@180 T@U) (arg1@@89 T@U) (arg2@@35 T@U) (arg3@@13 Bool) ) (! (= (type (|lambda#0| arg0@@180 arg1@@89 arg2@@35 arg3@@13)) (MapType4Type refType boolType))
 :qid |funType:lambda#0|
 :pattern ( (|lambda#0| arg0@@180 arg1@@89 arg2@@35 arg3@@13))
))))
...
(assert (forall ((arg0@@181 T@U) (arg1@@90 T@U) (arg2@@36 T@U) (arg3@@14 Bool) ) (! (= (type (|lambda#1| arg0@@181 arg1@@90 arg2@@36 arg3@@14)) (MapType4Type refType boolType))
 :qid |funType:lambda#1|
 :pattern ( (|lambda#1| arg0@@181 arg1@@90 arg2@@36 arg3@@14))
)))
...
(assert (forall ((|l#0@@1| T@U) (|l#1@@1| T@U) (|$y#0| T@U) ) (!  (=> (and (and (= (type |l#0@@1|) TyType) (= (type |l#1@@1|) (SeqType BoxType))) (= (type |$y#0|) BoxType)) (= (U_2_bool (MapType0Select (|lambda#2| |l#0@@1| |l#1@@1|) |$y#0|))  (and ($IsBox |$y#0| |l#0@@1|) (|Seq#Contains| |l#1@@1| |$y#0|))))
 :qid |unknown.0:0|
 :skolemid |909|
 :pattern ( (MapType0Select (|lambda#2| |l#0@@1| |l#1@@1|) |$y#0|))
)))
(assert (forall ((arg0@@182 T@U) (arg1@@91 T@U) (arg2@@37 T@U) (arg3@@15 Bool) ) (! (= (type (|lambda#4| arg0@@182 arg1@@91 arg2@@37 arg3@@15)) (MapType4Type refType boolType))
 :qid |funType:lambda#4|
 :pattern ( (|lambda#4| arg0@@182 arg1@@91 arg2@@37 arg3@@15))
)))
(assert (forall ((|l#0@@2| T@U) (|l#1@@2| T@U) (|l#2@@1| T@U) (|l#3@@1| Bool) ($o@@13 T@U) ($f@@1 T@U) ) (! (let ((alpha@@8 (FieldTypeInv0 (type $f@@1))))
 (=> (and (and (and (and (= (type |l#0@@2|) refType) (= (type |l#1@@2|) (MapType0Type refType MapType1Type))) (= (type |l#2@@1|) (FieldType boolType))) (= (type $o@@13) refType)) (= (type $f@@1) (FieldType alpha@@8))) (= (U_2_bool (MapType4Select (|lambda#4| |l#0@@2| |l#1@@2| |l#2@@1| |l#3@@1|) $o@@13 $f@@1))  (=> (and (not (= $o@@13 |l#0@@2|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@2| $o@@13) |l#2@@1|))) |l#3@@1|))))
 :qid |DafnyPreludebpl.129:1|
 :skolemid |910|
 :pattern ( (MapType4Select (|lambda#4| |l#0@@2| |l#1@@2| |l#2@@1| |l#3@@1|) $o@@13 $f@@1))
)))
(assert (forall ((arg0@@183 T@U) (arg1@@92 T@U) (arg2@@38 T@U) (arg3@@16 Bool) ) (! (= (type (|lambda#5| arg0@@183 arg1@@92 arg2@@38 arg3@@16)) (MapType4Type refType boolType))
 :qid |funType:lambda#5|
 :pattern ( (|lambda#5| arg0@@183 arg1@@92 arg2@@38 arg3@@16))
)))
(assert (forall ((|l#0@@3| T@U) (|l#1@@3| T@U) (|l#2@@2| T@U) (|l#3@@2| Bool) ($o@@14 T@U) ($f@@2 T@U) ) (! (let ((alpha@@9 (FieldTypeInv0 (type $f@@2))))
 (=> (and (and (and (and (= (type |l#0@@3|) refType) (= (type |l#1@@3|) (MapType0Type refType MapType1Type))) (= (type |l#2@@2|) (FieldType boolType))) (= (type $o@@14) refType)) (= (type $f@@2) (FieldType alpha@@9))) (= (U_2_bool (MapType4Select (|lambda#5| |l#0@@3| |l#1@@3| |l#2@@2| |l#3@@2|) $o@@14 $f@@2))  (=> (and (not (= $o@@14 |l#0@@3|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@3| $o@@14) |l#2@@2|))) |l#3@@2|))))
 :qid |DafnyPreludebpl.129:1|
 :skolemid |911|
 :pattern ( (MapType4Select (|lambda#5| |l#0@@3| |l#1@@3| |l#2@@2| |l#3@@2|) $o@@14 $f@@2))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (= (type |b#4|) (SeqType BoxType)) (= (type |a#0@@15|) (MapType0Type BoxType boolType))) (= (type SequenceSetsMod._default.ArbitrarySequentialization$T@@6) TyType)) (= (type |x#2@0|) BoxType)) (= (type $Heap@@2) (MapType0Type refType MapType1Type))) (= (type |b#Z#0@0|) (SeqType BoxType))) (= (type |##a#1@0|) (MapType0Type BoxType boolType))) (= (type $_Frame@0) (MapType4Type refType boolType))) (= (type |let#0#0#0|) (SeqType BoxType))) (= (type $_Frame@0@@0) (MapType4Type refType boolType))))
(push 1)
(set-info :boogie-vc-id CheckWellformed$$SequenceSetsMod.__default.ArbitrarySequentialization)
(set-option :timeout 0)
(set-option :rlimit 16350000)
(assert (not
 (=> (= (ControlFlow 0 0) 48107) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 48090) (- 0 48654)) (= (|Seq#Length| |b#4|) (|Set#Card| |a#0@@15|))) (=> (= (|Seq#Length| |b#4|) (|Set#Card| |a#0@@15|)) (=> (= (ControlFlow 0 48090) (- 0 48664)) (|Set#Equal| (SequenceSetsMod.__default.Members SequenceSetsMod._default.ArbitrarySequentialization$T@@6 |b#4|) |a#0@@15|))))))
(let ((anon8_correct  (=> (= (SequenceSetsMod.__default.ArbitrarySequentialization SequenceSetsMod._default.ArbitrarySequentialization$T@@6 ($LS $LZ) |a#0@@15|) |b#4|) (and (=> (= (ControlFlow 0 34654) (- 0 48653)) |b$reqreads#0@1|) (=> |b$reqreads#0@1| (=> (= (ControlFlow 0 34654) 48090) GeneratedUnifiedExit_correct))))))
(let ((anon7_correct  (and (=> (= (ControlFlow 0 34652) (- 0 48357)) (exists ((|x#3| T@U) ) (!  (and (= (type |x#3|) BoxType) (and ($IsBox |x#3| SequenceSetsMod._default.ArbitrarySequentialization$T@@6) (U_2_bool (MapType0Select |a#0@@15| |x#3|))))
 :qid |SequenceSetsbrokenidfy.21:11|
 :skolemid |905|
 :no-pattern (type |x#3|)
 :no-pattern (U_2_int |x#3|)
 :no-pattern (U_2_bool |x#3|)
))) (=> (exists ((|x#3@@0| T@U) ) (!  (and (= (type |x#3@@0|) BoxType) (and ($IsBox |x#3@@0| SequenceSetsMod._default.ArbitrarySequentialization$T@@6) (U_2_bool (MapType0Select |a#0@@15| |x#3@@0|))))
 :qid |SequenceSetsbrokenidfy.21:11|
 :skolemid |905|
 :no-pattern (type |x#3@@0|)
 :no-pattern (U_2_int |x#3@@0|)
 :no-pattern (U_2_bool |x#3@@0|)
)) (=> (and (and ($IsBox |x#2@0| SequenceSetsMod._default.ArbitrarySequentialization$T@@6) ($IsAllocBox |x#2@0| SequenceSetsMod._default.ArbitrarySequentialization$T@@6 $Heap@@2)) (U_2_bool (MapType0Select |a#0@@15| |x#2@0|))) (=> (and (and (and ($Is |b#Z#0@0| (TSeq SequenceSetsMod._default.ArbitrarySequentialization$T@@6)) ($IsAlloc |b#Z#0@0| (TSeq SequenceSetsMod._default.ArbitrarySequentialization$T@@6) $Heap@@2)) (= |##a#1@0| (|Set#Difference| |a#0@@15| (|Set#UnionOne| (|Set#Empty| BoxType) |x#2@0|)))) (and ($IsAlloc |##a#1@0| (TSet SequenceSetsMod._default.ArbitrarySequentialization$T@@6) $Heap@@2) (= |b$reqreads#0@0| (forall (($o@@15 T@U) ($f@@3 T@U) ) (! (let ((alpha@@10 (FieldTypeInv0 (type $f@@3))))
 (=> (and (and (= (type $o@@15) refType) (= (type $f@@3) (FieldType alpha@@10))) false) (U_2_bool (MapType4Select $_Frame@0 $o@@15 $f@@3))))
 :qid |SequenceSetsbrokenidfy.22:16|
 :skolemid |906|
...
))))) (and (=> (= (ControlFlow 0 34652) (- 0 48460)) (and (|Set#Subset| |##a#1@0| |a#0@@15|) (not (|Set#Subset| |a#0@@15| |##a#1@0|)))) (=> (and (|Set#Subset| |##a#1@0| |a#0@@15|) (not (|Set#Subset| |a#0@@15| |##a#1@0|))) (=> (|SequenceSetsMod.__default.ArbitrarySequentialization#canCall| SequenceSetsMod._default.ArbitrarySequentialization$T@@6 (|Set#Difference| |a#0@@15| (|Set#UnionOne| (|Set#Empty| BoxType) |x#2@0|))) (=> (and (= |let#0#0#0| (|Seq#Append| (SequenceSetsMod.__default.ArbitrarySequentialization SequenceSetsMod._default.ArbitrarySequentialization$T@@6 ($LS $LZ) (|Set#Difference| |a#0@@15| (|Set#UnionOne| (|Set#Empty| BoxType) |x#2@0|))) (|Seq#Build| (|Seq#Empty| BoxType) |x#2@0|))) (|SequenceSetsMod.__default.ArbitrarySequentialization#canCall| SequenceSetsMod._default.ArbitrarySequentialization$T@@6 (|Set#Difference| |a#0@@15| (|Set#UnionOne| (|Set#Empty| BoxType) |x#2@0|)))) (=> (and (and (and ($Is |let#0#0#0| (TSeq SequenceSetsMod._default.ArbitrarySequentialization$T@@6)) (= |b#Z#0@0| |let#0#0#0|)) (and (|$let#0$canCall| SequenceSetsMod._default.ArbitrarySequentialization$T@@6 |a#0@@15|) (= (SequenceSetsMod.__default.ArbitrarySequentialization SequenceSetsMod._default.ArbitrarySequentialization$T@@6 ($LS $LZ) |a#0@@15|) (let ((|b#5| (|Seq#Append| (SequenceSetsMod.__default.ArbitrarySequentialization SequenceSetsMod._default.ArbitrarySequentialization$T@@6 ($LS $LZ) (|Set#Difference| |a#0@@15| (|Set#UnionOne| (|Set#Empty| BoxType) |x#2@0|))) (|Seq#Build| (|Seq#Empty| BoxType) |x#2@0|))))
|b#5|)))) (and (and (|SequenceSetsMod.__default.ArbitrarySequentialization#canCall| SequenceSetsMod._default.ArbitrarySequentialization$T@@6 (|Set#Difference| |a#0@@15| (|Set#UnionOne| (|Set#Empty| BoxType) |x#2@0|))) ($Is (SequenceSetsMod.__default.ArbitrarySequentialization SequenceSetsMod._default.ArbitrarySequentialization$T@@6 ($LS $LZ) |a#0@@15|) (TSeq SequenceSetsMod._default.ArbitrarySequentialization$T@@6))) (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= (ControlFlow 0 34652) 34654)))) anon8_correct)))))))))))
(let ((anon11_Else_correct  (=> (and (not (and ($IsBox |x#2@0| SequenceSetsMod._default.ArbitrarySequentialization$T@@6) ($IsAllocBox |x#2@0| SequenceSetsMod._default.ArbitrarySequentialization$T@@6 $Heap@@2))) (= (ControlFlow 0 34650) 34652)) anon7_correct)))
(let ((anon11_Then_correct  (=> (and (and ($IsBox |x#2@0| SequenceSetsMod._default.ArbitrarySequentialization$T@@6) ($IsAllocBox |x#2@0| SequenceSetsMod._default.ArbitrarySequentialization$T@@6 $Heap@@2)) (= (ControlFlow 0 34648) 34652)) anon7_correct)))
(let ((anon10_Else_correct  (=> (not (= (|Set#Card| |a#0@@15|) (LitInt 0))) (and (=> (= (ControlFlow 0 34646) 34648) anon11_Then_correct) (=> (= (ControlFlow 0 34646) 34650) anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (= (|Set#Card| |a#0@@15|) (LitInt 0)) (=> (and (and (= (SequenceSetsMod.__default.ArbitrarySequentialization SequenceSetsMod._default.ArbitrarySequentialization$T@@6 ($LS $LZ) |a#0@@15|) (Lit (|Seq#Empty| BoxType))) ($Is (SequenceSetsMod.__default.ArbitrarySequentialization SequenceSetsMod._default.ArbitrarySequentialization$T@@6 ($LS $LZ) |a#0@@15|) (TSeq SequenceSetsMod._default.ArbitrarySequentialization$T@@6))) (and (= |b$reqreads#0@1| true) (= (ControlFlow 0 34639) 34654))) anon8_correct))))
(let ((anon9_Else_correct  (=> (= $_Frame@0@@0 (|lambda#5| null $Heap@@2 alloc false)) (and (=> (= (ControlFlow 0 34637) 34639) anon10_Then_correct) (=> (= (ControlFlow 0 34637) 34646) anon10_Else_correct)))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_Frame@0 (|lambda#4| null $Heap@@2 alloc false)) (and (=> (= (ControlFlow 0 34626) 34630) anon9_Then_correct) (=> (= (ControlFlow 0 34626) 34637) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and ($Is |a#0@@15| (TSet SequenceSetsMod._default.ArbitrarySequentialization$T@@6)) ($Is |b#4| (TSeq SequenceSetsMod._default.ArbitrarySequentialization$T@@6))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 48107) 34626))) anon0_correct))))
PreconditionGeneratedEntry_correct))))))))))))
))
(check-sat)
(get-info :reason-unknown)
(get-value ((ControlFlow 0 0)))
(get-value ((ControlFlow 0 48107)))
(get-value ((ControlFlow 0 34626)))
(get-value ((ControlFlow 0 34637)))
(get-value ((ControlFlow 0 34646)))
(get-value ((ControlFlow 0 34648)))
(get-value ((ControlFlow 0 34652)))
(get-value ((ControlFlow 0 34654)))
(get-value ((ControlFlow 0 48090)))
(assert (not (= (ControlFlow 0 48090) (- 48664))))
(check-sat)
(pop 1)
; Invalid
